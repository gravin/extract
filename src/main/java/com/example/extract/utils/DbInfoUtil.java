...
public class DbInfoUtil {
    ...
    public static Map<String, String> getTableRemarksMap(String driver, String url, String user, String pwd, String table) {
        List<Map<String, String>> list = getTableInfo(driver, url, user, pwd, table);
        Map<String, String> map = new HashMap<>();
        for (Map<String, String> tableInfo :
                list) {
            map.put(tableInfo.get("code"), tableInfo.get("name"));
        }
        return map;
    }
